...
- [ ] What is React JS and what problems does it try and solve? Support your answer with concepts introduced in class and from your personal research on the web. 
      React JS is a Javascript library that attempts to simplify and organize the complexity of dataflow in the browser. For example, as data (props) flows through the components (state) of an app, React handles the data through a Virtual DOM in order to update the state of singular components and avoid the need to re-render the entire page through the DOM. 

- [ ] What does it mean to _think_ in react?
      To think in React is to breakdown the userinterface into singular components that can be reused and scaffolded to acheive a downward data flow.

- [ ] Describe state.
      State is like the heart of the React App. State is what our data looks like at any given point. It is an object inside a class component that stores the current view of dynamic data. 

- [ ] Describe props.
      If state is like the heart, props is like the blood flowing through the React App. Props is the data being passed around to components to update the state and change the user view through the DOM.
